...
{
    public partial class frmunidadesMedidas : Form
    {
        int row = 0;
        ...
        private void frmunidadesMedidas_Load(object sender, EventArgs e)
        {
            ...
            this.Show();
            lbcodigo.Text = string.Format("{0:00000}", NUnidadMedida.CODIGO());
            CargarGrid();
        ...
        private void CargarGrid(string texto = "")
        {
            ...
            DataTable datos = NUnidadMedida.LISTAR(texto);
        ...
        private void btguardar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (NUnidadMedida.GUARDAR(txtnombre.Text.Trim()) == 1)
                {
            ...
            {
                if (NUnidadMedida.EDITAR(int.Parse(lbcodigo.Text), txtnombre.Text.Trim()) == 1)
                {
        ...
        private void gridview_ColumnAdded(object sender, DataGridViewColumnEventArgs e)
        {
            ...
            switch (e.Column.DataPropertyName)
            {
                ...
                case "nombre":
                    {
                        e.Column.HeaderText = "Unidad de Medidas";
                        e.Column.Width = 280;
                        break;
                    }
            }
        ...
        {
            lbcodigo.Text = string.Format("{0:00000}", int.Parse(gridview.Rows[row].Cells[0].Value.ToString().Trim()));
